...
urlpatterns = [
    ...
    path('mis-certificados/', views.mis_certificados_view, name='mis_certificados'),
    path('mis-certificados/<int:pk>/', views.ver_certificado_propio_view, name='ver_certificado_propio'),
